...
function ActionComment({id, CommentCount}) {
  ...
  return (
    ...
    <button className="tweet-action" onClick={() => onCommmentTweet(id)} >
      ...
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"  className="actionComment">
      ...
      <span className="tweet-action-count">{CommentCount}</span>
    </button>
